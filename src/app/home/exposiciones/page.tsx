...
export default async function ExposicionesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      {posts.length === 0 && (
        <p className="text-neutral-600">No hay exposiciones registradas.</p>
      )}

      <div className="space-y-4">
        {posts.map(post => (
          <div key={post.id} className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-xl font-semibold text-blue-900">{post.titulo}</h2>
            ...
            <a
              href={`/home/exposiciones/${post.id}`}
